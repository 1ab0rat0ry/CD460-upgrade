...
function DalkovaSvF(zapnute, delkaUpd, baterie, tlumene, levy, pravy)
    ...
    if not modelConfig[scriptVersion].ledDolni then
        if dalkoveLeve and stavDalkoveLeve < 5 then
            --and modelConfig[scriptVersion].horniPozicka
                    ...
                    if ID ~= nil and ID > 0 then
                        ...
                        if baterie == 1 then
                            if LVZnapeti < 1 and LVZvypinac then
                                --pokud je napeti mensi nez 1 (24V) a je sepnuty vypinac VZ
                            ...
                            if LVZvypinac and LVZrezim < 0.75 and releEPV and soupatkoVZ == 0 then
                                --pokud je zapaty HV, rezim je provoz, bezkontaktni menic bezi a je natazene soupatko, je VZ aktivni
                                kontrolaBdelosti = true
                                if LVZrezim > 0.25 then
                                    LVZzkouseni = true
                                end
                            elseif LVZrezim < 0.75 then
                                --pokud je zapaty HV a rezim je provoz a zaroven neni natazene soupatko, nebo vubec nebezi bezkontaktni menic
                                releEPV = false --rozhod rele EPV
                                kontrolaBdelosti = false
                                soupatkoVZ = 1 --odpadni soupatko
                            end
                            if LVZstart and LVZrezim > 0.75 and LVZvypinac and valcePrimocinne >= 1.8 and rychlostKolaKMHPodvozek1 < 15 then
                                --pokud je rezim postrk a je zapaty vypinac, je mozne nazhavit bezkontaktni menic
                                releEPV = true --natahni rele EPV
                                soupatkoVZ = 0 --natahuje soupatko
                            end
                            if LVZrezim > 0.75 then
                                --pokud je rezim postrk
                                kontrolaBdelosti = false
                                if not LVZvypinac then
                                    --zaroven pokud je zapaty HV
                                    soupatkoVZ = 0 --pritahni soupatko
                                end
                            end
                            if not LVZvypinac then
                                --pokud je vypaty vypinac LVZ
                                releEPV = false --rozhod rele EPV
                                kontrolaBdelosti = false
                                if LVZrezim < 0.75 then
                                    --pokud je rezim vlak
                                ...
                                --pokud bezi bezkontaktni menic, tj. je zapaty HV a baterie, sviti jeho kontrolka
                                if releEPV then
                        ...
                        if LVZnapeti > 0 and (not LVZvypinac or baterie ~= 1) then
                            --pokud je na Vmetru napeti a je vypaty HV
                        ...
                        if kontrolaBdelosti and baterie == 1 and soupatkoVZ == 0 then
                            --kontrola bdelosti
                        ...
                        if mgPrip > 0 and PC == 3.75 and hlavniVypinac > 0.5 and ((mgRezim == MG_VLASTNI and not vypnutyVuz) or (mgRezim == MG_NOUZOVY and vypnutyVuz)) then
                            if mgs == 1 or Call("GetControlValue", "mg", 0) > 0 then
                                --or auto_mgs == 1
                        ...
                        ----------------------------------------Vysilacka-----------------------------------------
                        if baterie == 1 then
                            if vysilackaObrazovka ~= vysilackaObrazovkaStara then
                                -- displej vys?la?ky
                            ...
                            if vysilackaObrazovka ~= 1 and vysilackaObrazovka ~= 0 then
                                -- zobrazen? ??sla vlaku a hodin a? po zapnut?
                                if vysilackaprihlasena ~= 1 then
                                    -- blik?n? odhl??en? vys?la?ky
                            ...
                            if vysilackaObrazovka == 6 or vysilackaObrazovka == 7 then
                                -- menu data
                                if tlacitko1 == 1 then
                                    tlacitko1 = 0
                            ...
                            if vysilackaObrazovka == 5 or vysilackaObrazovka == 4 then
                                -- zad?n? ??sla vlaku bez potvrzen?
                        ...
                        if baterie ~= 1 or Call("GetControlValue", "povel_HlavniVypinac", 0) == 0 then
                            Call("SetControlValue", "HlavniVypinac", 0, 0)
                        elseif ZamekHLvyp == 0 and baterie == 1 and Call("GetControlValue", "povel_HlavniVypinac", 0) == 1 and (hlavniVypinac == 1 or mgPrip == 0) then
                            --and ((RizenaRidici == "ridici" and povel_VlastniObaCizi < 1.5) or (RizenaRidici == "rizena" and povel_VlastniObaCizi > 0.5))
                        ...
                        if not modelConfig[scriptVersion].horniReflektor or modelConfig[scriptVersion].ledHorni then
                            --pokud je horni LED, nebo vubec nema reflektor, nema polohy N
                            if dalkovaSv < 0 then
                        ...
                        ----------------------------------------Klic HV-------------------------------------------
                        if klic == 1 then
                            -- Jenom pokud je klic ve zdirce
                            if PolohaKlice < 0.25 then
                                -- blokovani dolni schovane
                                Call("SetControlValue", "VirtualStartup", 0, 0.25)
                            end
                            if PolohaKlice > 0.75 then
                                -- blokovani horni schovane
                                Call("SetControlValue", "VirtualStartup", 0, 0.75)
                            end
                        end
                        ...
                        if JeNouzovyRadicVS == 0 and prepinaceTlak > 3.5 and baterie == 1 and not pojezdVDepu then
                            if kontroler == 0 or (JOB == 0) or Smer == 0 or (vykon > 0 and ojDiag == 1) or ((tlakVeValcich or casOJ > 1) and (vykon < 0 or kontroler < 0.25)) or ((zavedSnizenyVykon or snizenyVykonVozu) and kontroler >= 0) then
                                --and not fiktivniVykonNaObsazene
                                if kontroler == 0 then
                                    blokEDB = false
                                end
                        ...
                        if (PC == 3.75 and hlavniVypinac == 1 and baterie == 1 and not (snizenyVykonVozu and vykon > 0) and JOB ~= 0 and not vypnutyVuz) or pojezdVDepu then
                            -- kontrola podmínek pro jízdu
                        ...
                        if typSrazek ~= nil then
                            if typSrazek < 3 then
                                ...
                                if adhese_casdeste ~= -1 then
                                    --pokud prsi
                                    if adhese_casdeste < ADHESE_VLHKO_CAS_NABEH then
                                        --a prsi mene jak ADHESE_VLHKO_CAS_NABEH (70 vterin) - adhese se znizuje az na ADHESE_VLHKO_START (0.5)
                                        ambientAdhesion = ADHESE_SUCHO - (ADHESE_SUCHO - ADHESE_VLHKO_START) * (adhese_casdeste / ADHESE_VLHKO_CAS_NABEH)
                                    elseif adhese_casdeste < ADHESE_VLHKO_CAS_SNIZENI then
                                        --nebo prsi mene jak ADHESE_VLHKO_CAS_SNIZENI (370 vterin) - adhese se zvysuje na ADHESE_VLHKO (0.7)
                                        ...
                                        --jinak uz je adhese stala ADHESE_VLHKO (0.7)
                                        ambientAdhesion = ADHESE_VLHKO
                                    end
                                elseif adhese_caspodesti ~= -1 then
                                    --pokud prselo pred mene jak 10 minutami, adhese se zvysuje od aktualni k ADHESE_SUCHO (0.9)
                        ...
                        if adhese_caspodesti == -1 then
                            --pokud uz neprsi vice jak 10*casDeste vynuluj vychozi pocitadla - koleje uz jsou urcite suche
                            sourceAdhesion = -1
                        end

                        if SysCall("ScenarioManager:GetSeason") == 3 then
                            --pokud je zima, je snih - sankuje to 2x tolik jak obvykle
                            ambientAdhesion = ADHESE_SNIH
                        end
                        ...
                        if stridaveNap and baterie == 1 then
                            ...
                            --*******H12 PU
                            if Call("GetControlValue", "Napeti", 0) < 525 and vykon ~= 0 then
                                --2100V
                                diagPU = 1
                            ...
                            elseif Call("GetControlValue", "vybaveniDOTO", 0) >= 0.5 then
                                --predelat na tlacitko az bude
                                diagDOTO = 0
                            end
                            ...
                            elseif Call("GetControlValue", "vybaveniDOPM", 0) >= 0.5 then
                                --predelat na tlacitko az bude
                                diagMG = 0
                            end
                            ...
                            --*******H18 OJ
                            if (((vykon < 0 or vykon > 0.05) and math.abs(Ammeter) < 0.05) or (vykon < 0 and Ammeter > -251 and rychlost < 7) or (Call("GetControlValue", "Ammeter",
                                0) == 0 and (vykon < 0 or vykon > 0.05) and not pojezdVDepu and Call("GetIsEngineWithKey") == 1) or (snizenyVykonVozu and JOB == 1)) and not fiktivniVykonNaObsazene then
                                ojDiag = 1
                                casOJ = casOJ + cas
                            ...
                            -- 	jobDiag = 1
                            -- end
                            if (Call("GetControlValue", "VykonPredTrCh", 0) >= 0 and kontroler > 0.25 and kontroler < 0.75 and JOB ~= 1 and not fiktivniVykonNaObsazene) or (Call("GetControlValue", "VykonPredTrCh",
                                0) == 0 and kontroler > -0.25 and kontroler < 0.25 and JOB ~= 0) or (Call("GetControlValue", "VykonPredTrCh", 0) <= 0 and kontroler < -0.25 and kontroler > -0.75 and JOB ~= -1 and not fiktivniVykonNaObsazene) or (JOB == 0 and Call("GetControlValue", "JOBpovel",
                                0) ~= 0) then
                                jobDiag = 1
                            end
                ...
                if SvetlaAI == 1 then
                    if math.abs(deltaSpeed) > 0.1 then
                        ...
                        if vzdalenostAI < 300 then
                            reflektorAI = false
                            if 0 >= 0.5 then
                                --Call("PlayerEngine:GetControlValue", "Headlights", 0) or
